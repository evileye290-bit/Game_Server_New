...
{
    public class DivineLoveRank : BaseRank
    {
        public DivineLoveRank(CrossServerApi server, RankType rankType = RankType.DivineLove) : base(server, rankType)
        {
        }
        ...
        public void UpdateScore(int uid, int value, int addValue)
        {
            ...
            server.CrossRedis.Call(new OperateUpdateCrossRankScore(RankType.DivineLove, groupId, paramId, uid, value, server.Now()));
