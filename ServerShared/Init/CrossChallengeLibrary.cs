...
{
    public class CrossChallengeLibrary
    {
        ...
        public static int BattleRound => 3;
        ...
        private static void InitCrossConfig()
        {
            ...
            DataList dataList = DataListManager.inst.GetDataList("CrossChallengeConfig");
            ...
            CrossChallengeLibrary.timingList = timingList;
        ...
        private static void InitCrossLevelInfos()
        {
            ...
            CrossLevelInfo info;
            DataList dataList = DataListManager.inst.GetDataList("CrossChallengeLevel");
            foreach (var item in dataList)
            {
                Data data = item.Value;
            ...
            CrossChallengeLibrary.crossLevelInfos = crossLevelInfos;
        }
        ...
        private static void InitCrossGroups()
        {
            ...
            CrossChallengeLibrary.crossGroups = crossGroups;
            CrossChallengeLibrary.GroupList = GroupList;
        }
        ...
        private static void InitCrossFight()
        {
            ...
            DataList dataList = DataListManager.inst.GetDataList("CrossChallengeGroup");
            foreach (var item in dataList)
            {
                Data data = item.Value;
            ...
            CrossChallengeLibrary.FightGroupList = FightGroupList;
        }
        ...
        private static void InitCrossFightIndex()
        {
            ...
            DataList dataList = DataListManager.inst.GetDataList("CrossChallengeIndex");
            foreach (var item in dataList)
            {
                Data data = item.Value;
            ...
            CrossChallengeLibrary.FightIndexList = FightIndexList;
            CrossChallengeLibrary.fightList = fightList;
        }
        ...
        private static void InitCrossFinalsReward()
        {
            ...
            RankRewardInfo info;
            DataList dataList = DataListManager.inst.GetDataList("CrossChallengeFinalsReward");
            foreach (var item in dataList)
            {
            ...
            CrossChallengeLibrary.finalsRewards = finalsRewards;
        }
        ...
        private static void InitTimingDic()
        {
            ...
            CrossChallengeLibrary.prepareTimeDic = prepareTimeDic;
            CrossChallengeLibrary.guessingTimeDic = guessingTimeDic;
        }
        ...
        {
            WeekTimeSpan lastTimeSpan = CrossChallengeLibrary.GetWeekTime(lstTiming);
            if (lastTimeSpan == null)
            {
                return time;
            }
            WeekTimeSpan nextTimeSpan = CrossChallengeLibrary.GetWeekTime(nextTiming);
        ...
        {
            WeekTimeSpan weekTimeSpan = CrossChallengeLibrary.GetWeekTime(type);
        ...
        public static int AddStar(int winCount, int loseCount, out bool win)
        {
            win = false;
            if (winCount >= 3)
            {
            ...
            if (loseCount >= 3) return -2;
            if (loseCount >= 2) return -1;
