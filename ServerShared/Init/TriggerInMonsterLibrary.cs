...
{
    public class TriggerInMonsterLibrary
    {
        ...
        public static void Init()
        {
            ...
            DataList dataList = DataListManager.inst.GetDataList("TriggerInMonster");
            ...
            TriggerInMonsterLibrary.triggerList = triggerList;
        }
