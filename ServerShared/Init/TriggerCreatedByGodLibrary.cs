...
{
    public class TriggerCreatedByGodLibrary
    {
        ...
        public static void Init()
        {
            ...
            DataList dataList = DataListManager.inst.GetDataList("TriggerCreatedByGod");
            ...
            TriggerCreatedByGodLibrary.triggerList = triggerList;
        }
