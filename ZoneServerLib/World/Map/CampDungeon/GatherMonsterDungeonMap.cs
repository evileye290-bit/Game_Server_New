...
{
    public class GatherMonsterDungeonMap : DungeonMap
    {
        public GatherMonsterDungeonMap(ZoneServerApi server, int mapId, int channel) : base(server, mapId, channel)
        {
        ...
        protected override void Failed()
        {
            ...
            if (player != null)
            {
                player.CampGatherFailReward(DungeonModel, DungeonResult);
