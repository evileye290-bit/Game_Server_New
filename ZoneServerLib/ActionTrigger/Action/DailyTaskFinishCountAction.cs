...
namespace ZoneServerLib
{
    /// <summary>
    /// 每日任务完成数量
    /// model param1 每日任务完成数量
    /// </summary>
    public class DailyTaskFinishCountAction : BaseAction
    {
        public DailyTaskFinishCountAction(ActionManager manager, ActionModel model, ActionInfo actionInfo)
