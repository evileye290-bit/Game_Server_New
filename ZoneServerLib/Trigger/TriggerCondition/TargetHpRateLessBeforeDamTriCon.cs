...
{
    public class TargetHpRateLessBeforeDamTriCon : BaseTriCon
    {
        readonly float rate = 0;
        private FieldObject target = null;
        bool isCheck = false;
        public TargetHpRateLessBeforeDamTriCon(BaseTrigger trigger, TriggerCondition conditionType, string conditionParam)
