...
{
    public class NormalAttackCriticalTriCon : BaseTriCon
    {
        public NormalAttackCriticalTriCon(BaseTrigger trigger, TriggerCondition conditionType, string conditionParam)
